...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/dethdkn/nuxt-cap' },
      {
        icon: {
    ...
    nav: [
      ...
      { text: 'capjs.js.org', link: 'https://capjs.js.org' },
      {
        text: `V${version}`,
        items: [
          {
            text: 'Changelog',
            link: 'https://github.com/dethdkn/nuxt-cap/releases',
            target: '_blank',
          },
          { text: 'Bugs', link: 'https://github.com/dethdkn/nuxt-cap/issues', target: '_blank' },
          { text: 'Sponsor', link: 'https://github.com/sponsors/dethdkn', target: '_blank' },
        ],
      },
    ],
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'Composable', link: '/guide/composable' },
          { text: 'capjs.js.org', link: 'https://capjs.js.org' },
          {
            text: 'License',
            link: 'https://github.com/dethdkn/nuxt-cap/blob/main/LICENSE',
            target: '_blank',
          },
        ],
      },
    ...
    editLink: {
      pattern: 'https://github.com/dethdkn/nuxt-cap/edit/main/docs/:path',
